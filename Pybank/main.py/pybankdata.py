...
#print(max(Greatest_in_profit))
#print(min(Greatest_in_profit))
print(f'Greatest increase in profits: {(max(Greatest_in_profit))}')
print(f'Greatest decrease in profits: {(min(Greatest_in_profit))}')

# if profit == (max(Greatest_in_profit)):
#     print(profit)
# Specify the file to write to
output_path = os.path.join("..", "Analysis", "new1.csv")
